package com.example.grpc3.controllers;

import io.grpc.stub.StreamObserver;
import com.example.grpc3.services.CompteService;
import com.example.grpc3.stubs.*;
...
public class CompteServiceImpl extends CompteServiceGrpc.CompteServiceImplBase {
    ...
    public void saveCompte(SaveCompteRequest request, StreamObserver<SaveCompteResponse> responseObserver) {
        ...
        var compte = new com.example.grpc3.entities.Compte();
    ...
    public void getComptesByType(GetComptesByTypeRequest request, StreamObserver<GetComptesByTypeResponse> responseObserver) {
        ...
        List<com.example.grpc3.entities.Compte> comptes = compteService.GetComptesByType(typeCompte);
