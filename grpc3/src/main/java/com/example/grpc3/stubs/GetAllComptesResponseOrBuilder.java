...
public interface GetAllComptesResponseOrBuilder extends
   ...
   */
  java.util.List<com.example.grpc3.stubs.Compte> 
      getComptesList();
  /**
   * <code>repeated .Compte comptes = 1;</code>
   */
  com.example.grpc3.stubs.Compte getComptes(int index);
  /**
   * <code>repeated .Compte comptes = 1;</code>
   */
  int getComptesCount();
   ...
   * <code>repeated .Compte comptes = 1;</code>
   */
  java.util.List<? extends com.example.grpc3.stubs.CompteOrBuilder> 
      getComptesOrBuilderList();
  /**
   * <code>repeated .Compte comptes = 1;</code>
   */
  com.example.grpc3.stubs.CompteOrBuilder getComptesOrBuilder(
      int index);
}
